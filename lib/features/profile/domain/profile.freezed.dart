...
mixin _$Profile {
 ...
 String get id; String get username;@JsonKey(name: 'display_name') String get displayName; String? get bio;@JsonKey(name: 'avatar_url') String? get avatarUrl;@JsonKey(name: 'header_url') String? get headerUrl;@JsonKey(name: 'home_city_id') String? get homeCityId;@JsonKey(name: 'is_verified') bool get isVerified;@JsonKey(name: 'is_demo') bool get isDemo;@JsonKey(name: 'is_admin') bool get isAdmin;@JsonKey(name: 'onboarding_completed') bool get onboardingCompleted;@JsonKey(name: 'favorite_cuisines') List<String> get favoriteCuisines;@JsonKey(name: 'taste_tags') List<String> get tasteTags;@JsonKey(name: 'banner_style') String get bannerStyle;// Vertical crop of the custom banner photo: 0 top, 0.5 center, 1 bottom.
@JsonKey(name: 'header_focus_y') double get headerFocusY;@JsonKey(name: 'taste_personality') Map<String, dynamic> get tastePersonality;@JsonKey(name: 'created_at') DateTime get createdAt;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Profile&&(identical(other.id, id) || other.id == id)&&(identical(other.username, username) || other.username == username)&&(identical(other.displayName, displayName) || other.displayName == displayName)&&(identical(other.bio, bio) || other.bio == bio)&&(identical(other.avatarUrl, avatarUrl) || other.avatarUrl == avatarUrl)&&(identical(other.headerUrl, headerUrl) || other.headerUrl == headerUrl)&&(identical(other.homeCityId, homeCityId) || other.homeCityId == homeCityId)&&(identical(other.isVerified, isVerified) || other.isVerified == isVerified)&&(identical(other.isDemo, isDemo) || other.isDemo == isDemo)&&(identical(other.isAdmin, isAdmin) || other.isAdmin == isAdmin)&&(identical(other.onboardingCompleted, onboardingCompleted) || other.onboardingCompleted == onboardingCompleted)&&const DeepCollectionEquality().equals(other.favoriteCuisines, favoriteCuisines)&&const DeepCollectionEquality().equals(other.tasteTags, tasteTags)&&(identical(other.bannerStyle, bannerStyle) || other.bannerStyle == bannerStyle)&&(identical(other.headerFocusY, headerFocusY) || other.headerFocusY == headerFocusY)&&const DeepCollectionEquality().equals(other.tastePersonality, tastePersonality)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,username,displayName,bio,avatarUrl,headerUrl,homeCityId,isVerified,isDemo,isAdmin,onboardingCompleted,const DeepCollectionEquality().hash(favoriteCuisines),const DeepCollectionEquality().hash(tasteTags),bannerStyle,headerFocusY,const DeepCollectionEquality().hash(tastePersonality),createdAt);

@override
String toString() {
  return 'Profile(id: $id, username: $username, displayName: $displayName, bio: $bio, avatarUrl: $avatarUrl, headerUrl: $headerUrl, homeCityId: $homeCityId, isVerified: $isVerified, isDemo: $isDemo, isAdmin: $isAdmin, onboardingCompleted: $onboardingCompleted, favoriteCuisines: $favoriteCuisines, tasteTags: $tasteTags, bannerStyle: $bannerStyle, headerFocusY: $headerFocusY, tastePersonality: $tastePersonality, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String username,@JsonKey(name: 'display_name') String displayName, String? bio,@JsonKey(name: 'avatar_url') String? avatarUrl,@JsonKey(name: 'header_url') String? headerUrl,@JsonKey(name: 'home_city_id') String? homeCityId,@JsonKey(name: 'is_verified') bool isVerified,@JsonKey(name: 'is_demo') bool isDemo,@JsonKey(name: 'is_admin') bool isAdmin,@JsonKey(name: 'onboarding_completed') bool onboardingCompleted,@JsonKey(name: 'favorite_cuisines') List<String> favoriteCuisines,@JsonKey(name: 'taste_tags') List<String> tasteTags,@JsonKey(name: 'banner_style') String bannerStyle,@JsonKey(name: 'header_focus_y') double headerFocusY,@JsonKey(name: 'taste_personality') Map<String, dynamic> tastePersonality,@JsonKey(name: 'created_at') DateTime createdAt
});
...
as String,headerFocusY: null == headerFocusY ? _self.headerFocusY : headerFocusY // ignore: cast_nullable_to_non_nullable
as double,tastePersonality: null == tastePersonality ? _self.tastePersonality : tastePersonality // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String username, @JsonKey(name: 'display_name')  String displayName,  String? bio, @JsonKey(name: 'avatar_url')  String? avatarUrl, @JsonKey(name: 'header_url')  String? headerUrl, @JsonKey(name: 'home_city_id')  String? homeCityId, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'is_demo')  bool isDemo, @JsonKey(name: 'is_admin')  bool isAdmin, @JsonKey(name: 'onboarding_completed')  bool onboardingCompleted, @JsonKey(name: 'favorite_cuisines')  List<String> favoriteCuisines, @JsonKey(name: 'taste_tags')  List<String> tasteTags, @JsonKey(name: 'banner_style')  String bannerStyle, @JsonKey(name: 'header_focus_y')  double headerFocusY, @JsonKey(name: 'taste_personality')  Map<String, dynamic> tastePersonality, @JsonKey(name: 'created_at')  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Profile() when $default != null:
return $default(_that.id,_that.username,_that.displayName,_that.bio,_that.avatarUrl,_that.headerUrl,_that.homeCityId,_that.isVerified,_that.isDemo,_that.isAdmin,_that.onboardingCompleted,_that.favoriteCuisines,_that.tasteTags,_that.bannerStyle,_that.headerFocusY,_that.tastePersonality,_that.createdAt);case _:
  return orElse();
...
@override@JsonKey(name: 'header_focus_y') final  double headerFocusY;
...
as List<String>,bannerStyle: null == bannerStyle ? _self.bannerStyle : bannerStyle // ignore: cast_nullable_to_non_nullable
as String,headerFocusY: null == headerFocusY ? _self.headerFocusY : headerFocusY // ignore: cast_nullable_to_non_nullable
as double,tastePersonality: null == tastePersonality ? _self._tastePersonality : tastePersonality // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>,createdAt: null == createdAt ? _self.createdAt : createdAt // ignore: cast_nullable_to_non_nullable
as DateTime,
  ));
}
